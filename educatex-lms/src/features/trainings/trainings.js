...
class Trainings extends React.Component {
    ...
    componentDidMount() {
        fetch(
        "http://localhost:8080/api/elibrary/trainings", {headers: {"Authorization":'BearereyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJjaHJpcyIsImF1dGhvcml0aWVzIjpbeyJhdXRob3JpdHkiOiJzdHVkZW50OnJlYWQifSx7ImF1dGhvcml0eSI6IlJPTEVfUFJPRkVTU09SIn0seyJhdXRob3JpdHkiOiJjcGlyc2U6cmVhZCJ9LHsiYXV0aG9yaXR5IjoiY291cnNlOndyaXRlIn1dLCJpYXQiOjE2NDQyNjU4MjcsImV4cCI6MTY0NTM5ODAwMH0.mZJjI4IFGWsGebjdVLobbGTXm26URVr5KN0GN8Cqjys'}})
            .then((res) => 
            res.json())
            .then((json) => {
                this.setState({
